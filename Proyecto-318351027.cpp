...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// tori
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(25.0f, 1.29f, -150.0f));  // otra posición para que no se encime
		model = glm::rotate(model, -45.0f * toRadians, glm::vec3(0.0f, 1.0f, 0.0f)); // rotación en Y
		...
		// Casita12
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 1.29f, -150.0f));  // misma Z que tori
