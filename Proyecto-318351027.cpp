...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// Pucca
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(25.0f, 1.29f, -5.0f));  
		...
		/*********************************************************************************************/
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(110.0f, 0.75f, 2.0f));
		...
		// Lampara
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(26.0f, 0.0f, -70.0f));
		model = glm::scale(model, glm::vec3(7.5f, 7.5f, 7.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Lamp_M.RenderModel();
