...
int i_max_steps = 10; //Número de pasos entre cuadros para interpolación, a mayor número , más lento será el movimiento
int i_curr_steps = 0;
...
int main()
{
	...
	KeyFrame[6].movAvion_x = 16.0f;
	KeyFrame[6].movAvion_y = 16.0f;
	KeyFrame[6].giroAvion = -89.9999f;

	KeyFrame[7].movAvion_x = 20.0f;
	KeyFrame[7].movAvion_y = 16.0f;
	KeyFrame[7].giroAvion = -89.9999f;

	KeyFrame[8].movAvion_x = 24.0f;
	KeyFrame[8].movAvion_y = 16.0f;
	KeyFrame[8].giroAvion = -89.9999f;

	KeyFrame[9].movAvion_x = 28.0f;
	KeyFrame[9].movAvion_y = 16.0f;
	KeyFrame[9].giroAvion = -89.9999f;

	KeyFrame[10].movAvion_x = 32.0f;
	KeyFrame[10].movAvion_y = 16.0f;
	KeyFrame[10].giroAvion = -89.9999f;

	KeyFrame[11].movAvion_x = 36.0f;
	KeyFrame[11].movAvion_y = 16.0f;
	KeyFrame[11].giroAvion = -89.9999f;

	KeyFrame[12].movAvion_x = 40.0f;
	KeyFrame[12].movAvion_y = 16.0f;
	KeyFrame[12].giroAvion = -89.9999f;

	KeyFrame[13].movAvion_x = 44.0f;
	KeyFrame[13].movAvion_y = 20.0f;
	KeyFrame[13].giroAvion = -44.9999f;

	KeyFrame[14].movAvion_x = 48.0f;
	KeyFrame[14].movAvion_y = 24.0f;
	KeyFrame[14].giroAvion = 9.91821e-05f;

	KeyFrame[15].movAvion_x = 44.0f;
	KeyFrame[15].movAvion_y = 28.0f;
	KeyFrame[15].giroAvion = 45.0001f;

	KeyFrame[16].movAvion_x = 40.0f;
	KeyFrame[16].movAvion_y = 32.0f;
	KeyFrame[16].giroAvion = 90.0001f;

	KeyFrame[17].movAvion_x = 36.0f;
	KeyFrame[17].movAvion_y = 32.0f;
	KeyFrame[17].giroAvion = 90.0001f;

	KeyFrame[18].movAvion_x = 32.0f;
	KeyFrame[18].movAvion_y = 32.0f;
	KeyFrame[18].giroAvion = 90.0001f;

	KeyFrame[19].movAvion_x = 28.0f;
	KeyFrame[19].movAvion_y = 32.0f;
	KeyFrame[19].giroAvion = 90.0001f;

	KeyFrame[20].movAvion_x = 24.0f;
	KeyFrame[20].movAvion_y = 32.0f;
	KeyFrame[20].giroAvion = 90.0001f;

	KeyFrame[21].movAvion_x = 20.0f;
	KeyFrame[21].movAvion_y = 32.0f;
	KeyFrame[21].giroAvion = 90.0001f;

	KeyFrame[22].movAvion_x = 16.0f;
	KeyFrame[22].movAvion_y = 32.0f;
	KeyFrame[22].giroAvion = 90.0001f;

	KeyFrame[23].movAvion_x = 12.0f;
	KeyFrame[23].movAvion_y = 32.0f;
	KeyFrame[23].giroAvion = 90.0001f;

	KeyFrame[24].movAvion_x = 7.99999f;
	KeyFrame[24].movAvion_y = 32.0f;
	KeyFrame[24].giroAvion = 90.0001f;

	KeyFrame[25].movAvion_x = 3.99999f;
	KeyFrame[25].movAvion_y = 36.0f;
	KeyFrame[25].giroAvion = 45.0001f;

	KeyFrame[26].movAvion_x = -7.62939e-06f;
	KeyFrame[26].movAvion_y = 40.0f;
	KeyFrame[26].giroAvion = 9.91821e-05f;

	KeyFrame[27].movAvion_x = -7.62939e-06f;
	KeyFrame[27].movAvion_y = 36.0f;
	KeyFrame[27].giroAvion = 9.91821e-05f;

	KeyFrame[28].movAvion_x = -7.62939e-06f;
	KeyFrame[28].movAvion_y = 32.0f;
	KeyFrame[28].giroAvion = 9.91821e-05f;

	KeyFrame[29].movAvion_x = -7.62939e-06f;
	KeyFrame[29].movAvion_y = 28.0f;
	KeyFrame[29].giroAvion = 9.91821e-05f;

	KeyFrame[30].movAvion_x = -7.62939e-06f;
	KeyFrame[30].movAvion_y = 24.0f;
	KeyFrame[30].giroAvion = 9.91821e-05f;

	KeyFrame[31].movAvion_x = -7.62939e-06f;
	KeyFrame[31].movAvion_y = 20.0f;
	KeyFrame[31].giroAvion = 9.91821e-05f;

	KeyFrame[32].movAvion_x = -7.62939e-06f;
	KeyFrame[32].movAvion_y = 16.0f;
	KeyFrame[32].giroAvion = 9.91821e-05f;

	KeyFrame[33].movAvion_x = -7.62939e-06f;
	KeyFrame[33].movAvion_y = 12.0f;
	KeyFrame[33].giroAvion = 9.91821e-05f;

	KeyFrame[34].movAvion_x = -7.62939e-06f;
	KeyFrame[34].movAvion_y = 8.99998f;
	KeyFrame[34].giroAvion = 9.91821e-05f;

	KeyFrame[35].movAvion_x = -7.62939e-06f;
	KeyFrame[35].movAvion_y = 5.99998f;
	KeyFrame[35].giroAvion = 9.91821e-05f;

	KeyFrame[36].movAvion_x = -7.62939e-06f;
	KeyFrame[36].movAvion_y = 3.99998f;
	KeyFrame[36].giroAvion = 9.91821e-05f;

	KeyFrame[37].movAvion_x = -7.62939e-06f;
	KeyFrame[37].movAvion_y = 2.99998f;
	KeyFrame[37].giroAvion = 9.91821e-05f;

	KeyFrame[38].movAvion_x = -7.62939e-06f;
	KeyFrame[38].movAvion_y = 1.99998f;
	KeyFrame[38].giroAvion = 9.91821e-05f;

	KeyFrame[39].movAvion_x = -7.62939e-06f;
	KeyFrame[39].movAvion_y = 0.999985f;
	KeyFrame[39].giroAvion = 9.91821e-05f;

	KeyFrame[40].movAvion_x = -7.62939e-06f;
	KeyFrame[40].movAvion_y = -1.52588e-05f;
	KeyFrame[40].giroAvion = 9.91821e-05f;
